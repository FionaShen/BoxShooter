...
public class GameManager : MonoBehaviour {
	...
	public void targetHit (TargetBehavior.scoreMethod calculationMethod, int scoreAmount, float timeAmount)
	{
		// increase the score by the scoreAmount and update the text UI
		switch(calculationMethod) {
		case TargetBehavior.scoreMethod.addition:
			score += scoreAmount;
			break;
		case TargetBehavior.scoreMethod.multiplication:
			score *= scoreAmount;
			break;
		case TargetBehavior.scoreMethod.division:
			score /= scoreAmount;
			break;
		}
